...
#include <linux/fs.h> 
/* 
 * get_block - for the file associated with the giv
en fd, returns 
...
/* 
 * get_nr_blocks - returns the number of logical bl
ocks 
...
/* 
 * print_blocks - for each logical block consumed b
y the file 
 * associated with fd, prints to standard out the t
uple 
