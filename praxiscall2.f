       PROGRAM PRAXISCALL
       implicit none
       REAL*8 T01,MACHEP1,X1(20),FMIN1,F,H01,PRAXIS
       real*8 Y1
       INTEGER N1,PRIN1, i
       external F
       T01 = 6.0
       ...
       X1(2)=3
       FMIN1=1.0
       Y1=PRAXIS(T01,MACHEP1,H01,N1,PRIN1,X1,F,FMIN1)
       PRINT *,T01,MACHEP1,H01,N1,PRIN1,X1,FMIN1,Y1       
C                             
C              
       END PROGRAM
          REAL*8 FUNCTION PRAXIS(T0,MACHEP,H0,N,PRIN,X,F,FMIN)
C                             LAST MODIFIED 3/1/73
       REAL*8 T0,MACHEP,H0,X(2),F,FMIN
       EXTERNAL F
       INTEGER PRIN
C
